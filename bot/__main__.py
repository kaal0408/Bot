...
from bot.Handlers.validation import is_user_admin
...
def start(update: Update, context: CallbackContext):
    ...
    [
        ...
        InlineKeyboardButton(
            text="Bot Info", callback_data="bot_"
        ),
    ],
    [
...
def bot_about_callback(update: Update, context: CallbackContext):
    first_name = update.effective_user.first_name
    ...
    if query.data == "bot_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                   [
                     InlineKeyboardButton(text="Support", url="https://t.me/MAMBA_X_SUPPORT"),
                     InlineKeyboardButton(text="News", url="https://t.me/MAMBA_NETWORK"),
                   ],
                   [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(bot_about_callback, pattern=r"bot_", run_async=True)
