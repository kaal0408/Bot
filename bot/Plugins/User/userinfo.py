...
from bot.__help__ import STATS, USER_INFO
import bot.Database.userinfo_sql as sql
from bot.Plugins.disable import DisableAbleCommandHandler
from bot.Database.global_bans_sql import is_user_gbanned
from bot.Database.afk_sql import is_afk, check_afk_status
from bot.Database.users_sql import get_user_num_chats
from bot.Handlers.validation import sudo_plus, user_admin, support_plus
from bot.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n┣|• This user is member of 'bot Developer Team'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/bot_Updates">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/bot_Updates)
"""
__mod_name__ = "Infos"
