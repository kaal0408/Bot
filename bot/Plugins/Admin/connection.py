...
import bot.Database.connection_sql as sql
from bot import dispatcher, INSPECTOR, DEV_USERS
from bot.Handlers import validation
...
__help__ = """
Sometimes, you just want to add some notes and filters to a group chat, but you don't want everbot to see; This is where connections come in...
