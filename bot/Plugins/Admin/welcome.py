...
import bot
import bot.Database.welcome_sql as sql
import bot.Database.global_bans_sql as gban_sql
from bot import (
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll go loaf around and not welcome anbot then.",
            )
